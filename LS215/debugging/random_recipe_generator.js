...
// The bug is on line 41 where we try to concatenate 3 arrays. 
// This coerces the arrats into a string.
// Join is not a string method, which is why it raises an error. 