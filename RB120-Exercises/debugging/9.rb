...
# What can we see?
. johns_postal_service is an instance of class PostalService
. PostalService deos not have #send method, the Mailing class does.
. Instead it invokes the send method from parent class `Object`?

# What can be done?
. Assuming that Postal Service should have access to Mailing methods,
. we can include Mailing into PostalService class.
. Now , we can call #send that is inherited from the Mailing module.
